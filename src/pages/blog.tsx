...
export function BlogPage() {
	...
	return (
		<div className='relative min-h-screen bg-gradient-to-br bg-gradient-to-br from-gray-950 via-indigo-950 to-purple-950 overflow-hidden'>
			{/* Dynamic floating particles */}
			<div className='absolute inset-0 pointer-events-none'>
			...
			<Container>
<section className='relative z-10 py-16 lg:py-24 bg-gradient-to-br from-gray-950 via-indigo-950 to-purple-950'>
					
				  {/* Title */}
  <div className='text-center mb-16'>
    <div className='relative inline-block'>
      {/* Decorative geometric accents */}
      <div className='absolute -top-8 -left-8 w-24 h-24 bg-gradient-to-br from-pink-500/10 to-purple-500/10 rounded-full blur-md'></div>
      <div className='absolute -bottom-6 -right-6 w-16 h-16 bg-gradient-to-br from-cyan-400/20 to-blue-600/10 transform rotate-45 opacity-50'></div>

      {/* Main Title */}
      <div className='relative overflow-hidden'>
        <h1 className='text-5xl sm:text-6xl lg:text-7xl font-black leading-none text-white'>
          <span className='block transform hover:-translate-y-1 transition-transform duration-500'>MUSIC</span>
        ...
        {/* Divider */}
        <div className='absolute top-1/2 left-0 w-full h-1 bg-gradient-to-r from-transparent via-indigo-500 to-transparent transform -translate-y-1/2 opacity-50'></div>
      </div>

      {/* Floating elements */}
      <div className='absolute -top-6 -left-6 w-6 h-6 bg-yellow-300 transform rotate-45 animate-pulse'></div>
      <div className='absolute -bottom-8 -right-8 w-8 h-8 bg-fuchsia-500 rounded-full animate-bounce'></div>
    </div>
								...
								{filteredArticles?.map((article, index) => (
									<div key={article.id} className='group relative'>
										...
										<div className={`
											...
											${index % 5 === 2 ? 'bg-gradient-to-br from-violet-400 to-purple-500' : ''}
											${index % 5 === 3 ? 'bg-gradient-to-br from-pink-400 to-rose-500' : ''}
											${index % 5 === 4 ? 'bg-gradient-to-br from-cyan-400 to-blue-500' : ''}
										`}>
